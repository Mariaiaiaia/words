                    ...
                    <div className={`${Card.card} ${Border.end_in}`}>
                        <div className={end.container}>
                            ...
                            <div className={end.container_btns}>
                                <motion.button variants={btn} animate={"visible"} initial={"hidden"} className={end.finish_btn} ><Link className={end.link_btn} to={{pathname:'/exam'}}>start new test</Link></motion.button>
                                <motion.button variants={btn} animate={"visible"} initial={"hidden"} className={end.finish_btn} ><Link className={end.link_btn} to={{pathname:'/learn'}}>learn words</Link></motion.button>
                            </div> 
                        </div> 
                    </div>
                </div>
